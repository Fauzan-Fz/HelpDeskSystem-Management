...
//            //    .GroupBy(u => string.IsNullOrEmpty(u.FullName) ? "Unknown" : u.Gender)
//            //    .Select(g => new
//            //    {
//            //        Gender = g.Key,
//            //        Count = g.Count()
...
//            //var labels = genderCounts.Select(g => g.Gender).ToArray();
//            //var data = genderCounts.Select(g => g.Count).ToArray();
